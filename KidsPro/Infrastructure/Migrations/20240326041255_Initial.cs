    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderDetailStudent", x => new { x.OrderDetailId, x.StudentId });
                    table.ForeignKey(
                        name: "FK_OrderDetailStudent_OrderDetails_OrderDetailId",
                        column: x => x.OrderDetailId,
                        principalTable: "OrderDetails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OrderDetailStudent_Students_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Students",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, new DateTime(2024, 3, 26, 4, 12, 54, 509, DateTimeKind.Utc).AddTicks(4695), null, "admin@gmail.com", "Admin", null, false, "$2a$11$6ha6FueEZiQnabbcJ9Id3.2iJeA8E/TlpvzgVQHew1QqIdcv9fBRC", null, 1, (byte)1 },
                    { 2, null, new DateTime(2024, 3, 26, 4, 12, 54, 727, DateTimeKind.Utc).AddTicks(2647), null, "subadmin@gmail.com", "Sub Admin", null, false, "$2a$11$lnl7hfgNLBsFAhWxisdhMuLYn/eC/RdZCHP/LJgG8YSBgNwCsMAZa", null, 1, (byte)1 },
                    { 3, null, new DateTime(2024, 3, 26, 4, 12, 54, 940, DateTimeKind.Utc).AddTicks(6086), null, "teacher@gmail.com", "Teacher", null, false, "$2a$11$aNyGHR7kiY2CWHg7wQKEgeZ8Tam7AjIxWg1DygITuo1ItHxP0eW/W", null, 3, (byte)1 },
                    { 4, null, new DateTime(2024, 3, 26, 4, 12, 55, 159, DateTimeKind.Utc).AddTicks(5593), null, "teacher2@gmail.com", "Teacher 2", null, false, "$2a$11$GNelZB770TYJGe.NpeXc0.zj5iE0xgepiC8Ky6Y1EhBWpQy.0Em.O", null, 3, (byte)1 },
                    { 5, null, new DateTime(2024, 3, 26, 4, 12, 55, 385, DateTimeKind.Utc).AddTicks(109), null, "staff@gmail.com", "Staff", null, false, "$2a$11$Kr5kvDNOQr19wrw3HfJ/1ufDEV9VD4xDXYjQSE8lgsh45Hbwfe0lK", null, 2, (byte)1 }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderDetailStudent_StudentId",
