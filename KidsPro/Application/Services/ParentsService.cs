...
namespace Application.Services
{
    public class ParentsService: IParentsService
    {
        ...
        public async Task<StudentDto> AddStudentAsync(StudentAddDto request)
        {
        ...
        public async Task<List<StudentDto>> GetStudentsAsync(int parentId)
        {
            var list = await _unitOfWork.StudentRepository.GetStudents(parentId);
            return  ParentMapper.ParentShowListStudent(list);
        }

        public async Task<StudentDetailDto> GetDetailStudentAsync(int studentId)
        {
        ...
        public ParentOrderDto GetEmailZalo(int parentId)
        {
